...
${selectedResponsibilities || '(Nenhuma responsabilidade selecionada)'}

2. À Primeira Contraente NÃO cabe qualquer despesa com o veículo, limitando-se ao pagamento da renda semanal acordada.`;

        previewContent = previewContent.replace('{{CLAUSULA_QUARTA_RESPONSABILIDADES}}', responsibilitiesClause);
    }
        ...
        <div className="glass-effect rounded-xl p-8 fade-in">
            ...
            <div className="flex justify-between items-center gap-4">
                ...
                <div className="flex items-center gap-4">
                     <button onClick={handleCopy} className="px-6 py-3 bg-gray-600 hover:bg-gray-500 text-white rounded-lg font-semibold transition-all duration-300 flex items-center space-x-2">
