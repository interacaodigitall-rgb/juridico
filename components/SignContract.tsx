...
const SignContract: React.FC<SignContractProps> = ({ template, formData, contractType, onBack, onComplete }) => {
    ...
    const allSignaturesCollected = Object.keys(signatures).length >= signers.length;
        ...
        <>
            ...
            <div className="glass-effect rounded-xl p-8 fade-in">
                ...
                <div className="mt-10 flex justify-between">
                    <button onClick={onBack} className="px-8 py-3 bg-gray-700 hover:bg-gray-600 text-white rounded-lg font-semibold">Voltar</button>
                    <button onClick={() => onComplete(signatures)} disabled={!allSignaturesCollected} className="px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg font-semibold flex items-center space-x-2 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:from-gray-600 disabled:to-gray-700">
